            ...
            <nav class="navbar py-4">
                <div class="container-xxl">
                    ...
                    <div class="h-right d-flex align-items-center mr-5 mr-lg-0 order-1">
                        <div class="d-flex">
                            <!-- <a class="nav-link text-primary collapsed" href="#" title="Logout">
                        ...
                        <div class="dropdown notifications zindex-popover">
                            <a class="nav-link dropdown-toggle pulse" href="#" role="button" data-bs-toggle="modal" data-bs-target="#logout" title="logout">
                                <i class="icofont-ui-power fs-3 text-danger"></i>
                                    ...
                                    <div class="card-body pb-0">
                                        <div class="d-flex py-1">
                                            ...
                                            <div class="flex-fill ms-3">
                                                ...
                                                <small class=""><?=$this->session->email;?></small>
                                            </div>
                                        </div>
