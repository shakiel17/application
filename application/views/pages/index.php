                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4" action="<?=base_url('authenticate');?>" method="POST">
                                <div class="col-12 text-center mb-1 mb-lg-5">
                                    ...
                                    <span>Please sign in to proceed on recruitment process.</span>
                                </div>                                                                
                                <div class="col-12">
                                    <div class="mb-2">
                                ...
                                <div class="col-12 text-center mt-4">
                                    <button type="submit" class="btn btn-lg btn-block btn-light lift text-uppercase" alt="SIGNUP">SIGN IN</button>
                                </div>
                                <div class="col-12 text-center mt-4">
                                    <span class="text-muted">Already have an account? <a href="<?=base_url('register');?>" title="Sign in" class="text-secondary">Sign up here</a></span>
                                </div>
                            </form>
                            <!-- End Form -->
                        </div>
